...
import { useLokasiById, useUpdateLokasi } from "@/hooks/use-lokasi";
...
export default function EditLokasiPage() {
  ...
  const { data: lokasi, isLoading: isFetching, isError: isFetchError } = useLokasiById(id);
  const { mutate: updateLokasi, isPending, isError, isSuccess, error } = useUpdateLokasi();
        ...
        <div className="flex flex-col items-center gap-3 rounded-lg border border-destructive/30 bg-destructive/5 py-16 text-center">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Data lokasi mungkin telah dihapus.
            </p>
          </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Ubah data koordinat atau nama lokasi absensi.
          </p>
        </div>
      </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription className="mt-1">
                      Klik pada peta atau seret marker untuk mengubah titik absensi
                    </CardDescription>
                  </div>
                  <Button
                    type="button"
          ...
          <div className="lg:col-span-2">
            <Card className="h-full">
              <CardHeader>
                ...
                <CardDescription>
                  Ubah informasi nama lokasi dan atur radius absensi
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-5">
                ...
                {isSuccess && (
                  <div className="flex items-start gap-2 rounded-md bg-emerald-500/10 px-3 py-2.5 text-sm text-emerald-600">
                    ...
                    <span>Lokasi berhasil diperbarui! Mengalihkan...</span>
                  </div>
                )}
